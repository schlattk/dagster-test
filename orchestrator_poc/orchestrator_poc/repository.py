...
from orchestrator_poc.jobs.airbyte_jobs import run_salesforces_stronger_nudge, run_salesforce_fund, run_airbyte_and_then_dbt_cli
...
def orchestrator_poc():
    ...
    """
    jobs = [run_in_order, run_salesforce_fund, run_salesforces_stronger_nudge, run_airbyte_and_then_dbt_cli, run_dbt_job, full_dbt_job, test_dbt_job, seed_dbt_job]
    schedules = [basic_schedule, dbt_schedule]
    sensors = [my_sensor, slack_on_run_failure]
