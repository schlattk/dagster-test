...
from orchestrator_poc.jobs.airbyte_jobs import run_dagster_airbyte, run_airbyte_and_then_dbt, run_airbyte_and_then_dbt_cli
...
def orchestrator_poc():
    ...
    """
    jobs = [run_in_order, run_dagster_airbyte, run_dbt_rpc_job, run_dbt_rpc_sync_job, run_airbyte_and_then_dbt, run_dbt_ssh_job, run_airbyte_and_then_dbt_cli]
    schedules = []
    sensors = [my_sensor]
